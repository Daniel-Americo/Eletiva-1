...
<html lang="en">
  ...
  <body>
  <form method="post" action="exe18_resposta.php">
    ...
    <div class="mb-3">
        ...
        <input type="number" id="taxa" name="taxa" class="form-control">
    </div>

    <div class="mb-3">
        <label for="periodo" class="form-label">Insira o periodo:</label>
        <input type="number" id="periodo" name="periodo" class="form-control">
    </div>
